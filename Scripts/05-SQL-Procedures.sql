...
IF OBJECT_ID ( 'dbo.PRC_POLIZAS_POR_TRASPASAR_CXP', 'P' ) IS NOT NULL 
...
AS
	...
	FROM #POLIZASCXP AS P 
		LEFT JOIN VMX_CONTOLPOLIZA_LINE AS PL 
			ON P.BANK_ACCOUNT_ID = PL.BANK_ACCOUNT_ID AND P.CONTROL_NO = PL.CONTROL_NO AND P.VAT_GL_ACCT_ID = PL.CUENTA AND P.SITE_ID = PL.SITE_ID
...
IF OBJECT_ID ( 'dbo.PRC_POLIZAS_POR_TRASPASAR_CXC', 'P' ) IS NOT NULL 
...
AS
	...
	FROM #POLIZASCXC AS P 
		LEFT JOIN VMX_CONTOLPOLIZA_LINE AS PL 
			ON P.BANK_ACCOUNT_ID = PL.BANK_ACCOUNT_ID AND P.CONTROL_NO = PL.CHECK_ID AND P.SITE_ID = PL.SITE_ID --AND P.VAT_GL_ACCT_ID = PL.CUENTA
